...
## Questions ouvertes
- Matériel : GPU intégré type AMD APU ? NVIDIA ? Custom ?
- OS : Linux custom ? NixOS ?
- Interface : CLI uniquement, interface web locale, ou écran intégré ?
- Facteur de forme : boîtier HTPC ? Stick HDMI ? Boîtier de bureau ?
- Rapport avec SteamDeck : portabilité ? Manettes ?
