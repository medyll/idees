...
## Questions ouvertes
- La hiérarchie est-elle plate (tags) ou strictement arborescente ?
- Héritage des champs de définition : un animal hérite-t-il des champs "être vivant" ?
- Connexion avec **idea-MATURATION** pour faire mûrir cette ontologie ?
- Données source : DBpedia, Wikidata, ou base custom ?
